...
<form class="forms" method="post">
 <br>
 Номер вагона:<p><input type="text" name="num"></p>
 Тип:<p class="forms"><input type="text" name="type"></p>
 Год сборки:<p class="forms"><input type="text" name="age"></p>
 <p><input type="submit" name="pend" value="Добавить"></p>
	...
	$final = $link->query("insert into wagons values('DEFAULT', '{$num}', '{$type}', '{$age}')");
    $link->close();  
