...
<br>
<div class="text-center"><h3>Список Ремонтов</h3></div>
<div class="card-deck">
    <br>
<?php
$counter = 0;   
...
while ($r = $result->fetch_assoc())
{
	...
	echo "<div class='card text-center'>
      ...
      <ul class='list-group list-group-flush'>
        <li class='list-group-item'>Результат: ".$r['result']."</li>
        <li class='list-group-item'>Начало ремонта: ".$r['day_start']."</li>
        <li class='list-group-item'>Окончание ремонта: ".$r['day_stop']."</li>
        <li class='list-group-item'>Ремонтируемый вагон: ".$r['wagon']."</li>
      </ul>
        <div class='card-body' >
            <a href='repairdetail.php?G=".$id."' class='card-link'>detail</a>
            <a href='updaterepair.php?G=".$id."' class='card-link'>update</a>
            <a href='repairdelete.php?G=".$id."' class='card-link'>delete</a>
        </div>
    </div>
	";
    $counter++; 
