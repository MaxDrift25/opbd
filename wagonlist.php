...
<br>
<div class="text-center"><h3>Список Вагонов</h3></div>
<div class="card-deck">
    <br>
    <?php
$counter = 0;   
$x = new mysqli('localhost', 'root', '', 'r_w');
$result = $x->query("SELECT * FROM wagons");
while ($r = $result->fetch_assoc())
{
	...
	echo "<div class='card text-center'>
      ...
      <ul class='list-group list-group-flush'>
        <li class='list-group-item'>Номер вагона: ".$r['reg_number']."</li>
        <li class='list-group-item'>Тип вагона: ".$r['type']."</li>
        <li class='list-group-item'>Год сборки: ".$r['type_year']."</li>
      </ul>
        <div class='card-body' >
            <a href='updatewagon.php?G=".$id."' class='card-link'>update</a>
            <a href='wagondelete.php?G=".$id."' class='card-link'>delete</a>
        </div>
    </div>
	";
    $counter++; 
