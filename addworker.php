...
<form class="forms" method="post">
 <br>
 Табельный номер:<p><input type="text" name="tab_num"></p>
 ФИО:<p><input type="text" name="fio"></p>
 Стаж:<p><input type="text" name="year"></p>
 Образование:<p><input type="text" name="base"></p>
 <p><input type="submit" name="pend" value="Добавить"></p>
	...
	$final = $link->query("insert into worker values('DEFAULT', '{$tab_num}', '{$fio}', '{$year}', 
    '{$base}')");
    $link->close();  
